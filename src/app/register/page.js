...
export default function RegisterPage() {
  ...
  return (
    <div className="flex justify-evenly items-center">
      {/* Hide image on mobile or small tablets */}
      ...
      <section className="mt-8 w-[400px]">
        ...
        <form className="block max-w-xs mx-auto" onSubmit={handleFormSubmit}>
          ...
          <div className="my-4 text-center text-gray-100">or login with provider</div>
          <button onClick={() => signIn('google', {callbackUrl:'/'})} className="flex gap-4 justify-center">
            <Image src={'/google.png'} alt={''} width={24} height={24} />
            Login with google
          </button>
          <div className="text-center my-4 text-gray-100 border-t pt-4">
            Existing account?{' '}
